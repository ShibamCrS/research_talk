...
\scalebox{0.375}{\includegraphics{./fig/QARMA-FAMILY.pdf}}

\scalebox{0.475}{\includegraphics{./fig/QARMAv1-full-round.pdf}}
%%%%
\qquad\qquad%
...
\begin{align*}
    \centering
    \scalebox{1.2}{\includegraphics{./fig/column-number-map-0.pdf}} & \quad \quad
    \scalebox{1.2}{\includegraphics{./fig/column-number-map-1.pdf}}
    \\\\
    \scalebox{1.2}{\includegraphics{./fig/column-number-map-2.pdf}} & \quad \quad
    \scalebox{1.2}{\includegraphics{./fig/column-number-map-3.pdf}}
\end{align*}
\end{frame}
...
\begin{figure}[t]
    \centering
    \scalebox{0.55}{\includegraphics{./fig/structure.pdf}}
\end{figure}
\pause
...
\begin{frame}
    \frametitle{Cryptanalysis 1: \blue{Real} vs \green{Ideal} Distinguishing Game}
\centering
\textcolor{blue}{$\mathcal{E} \colon \mathcal{P} \times \mathcal{K} \to \mathcal{C}$} is a block cipher and \green{$\Pi$} is a random permutation
    ...
    \begin{center}
        \begin{tikzpicture}[transform shape, scale=1]
            ...
            \node[inner sep=0pt](A) at (2,-4){\includegraphics[width=.125\textwidth]{./fig/think.png}};
...
% \begin{figure}[!t]
%     \scalebox{0.599}{\includegraphics{./fig/QARMAv1-full-round.pdf}}
% \end{figure}
% \begin{enumerate}
% {\footnotesize
...
\begin{align*}
    \!\!\scalebox{0.666}{%
        \begin{tikzpicture}
             \node[anchor=north west] at (0,0) {\includegraphics{./fig/qarmav1_r_333_t_1_KR_wf_0_zc_4_W_24.pdf}};
...
\frametitle{Key Recovery Goal}
    \centering
    \scalebox{0.64}{\includegraphics{./fig/through-one-half-rounds-1.pdf}}%
    ...
    \medskip
    \centering
    \scalebox{0.64}{\includegraphics{./fig/through-one-half-rounds-key-add-shifted-two-cells.pdf}}%
...
\begin{align*}
    \!\!\scalebox{0.6}{%
        \begin{tikzpicture}
        \node[anchor=north west] at (0,0) {\includegraphics{./fig/qarmav1_r_333_t_1_KR_zc_0.pdf}};
            \node[inner sep=0pt,fill=white] at (.425,-2.35) {\small\textcolor{blue}{{\bfseries 0}}};
            \node[inner sep=0pt,fill=white] at (.725,-2.35) {\small\textcolor{blue}{{\bfseries 0}}};
...
\!\!\scalebox{0.6}{%
        \begin{tikzpicture}
\node[anchor=north west] at (0,0) {\includegraphics{./fig/qarmav1_r_333_t_1_KR_zc_2_(4,6,7,8,11,13,14)_44_ASSERT_FT2r0=0b0010.pdf}};
            \node[inner sep=0pt,fill=white] at (.425,-2.35) {\small\textcolor{blue}{{\bfseries 0}}};
            \node[inner sep=0pt,fill=white] at (.725,-2.35) {\small\textcolor{blue}{{\bfseries 0}}};
            \draw[color=blue,rounded corners=1.667pt,semithick,small cross line] (0.31,-4.235) -- (0.84,-4.235) -- (0.84,-4.465) -- (0.31,-4.465) -- cycle;
        \end{tikzpicture}\!\!\!}
...
\begin{align*}
    \!\!\scalebox{0.6}{%
        \begin{tikzpicture}
        \node[anchor=north west] at (0,0) {\includegraphics{./fig/qarmav1_r_323_t_1_KR_zc_3_(3,4,7,9,11,12,14)_50.pdf}};
            \node[inner sep=0pt,fill=white] at (.425,-2.35)  {\small\textcolor{blue}{{\bfseries 0}}};
            \node[inner sep=0pt,fill=white] at (.725,-2.35)  {\small\textcolor{blue}{{\bfseries 0}}};
            \draw[color=blue,rounded corners=1.667pt,semithick,small cross line] (0.31,-4.235) -- (0.84,-4.235) -- (0.84,-4.465) -- (0.31,-4.465) -- cycle;
        \end{tikzpicture}\!\!\!}
...
\begin{figure}
    \scalebox{0.5}{\includegraphics{./fig/success-probability-1-tight.pdf}} \quad
    \scalebox{0.5}{\includegraphics{./fig/success-probability-1-wide.pdf}}
\end{figure}
\pause
\begin{enumerate}
...
\begin{figure}
\scalebox{0.4}{\includegraphics{./fig/success-probability-1-wide.pdf}}\\
\vfill
\hspace{-0.45cm}\scalebox{0.4}{\includegraphics{./fig/success-probability-1-tight.pdf}}
\end{figure}
\end{column}
