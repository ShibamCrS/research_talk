...
% \usetheme{Madrid}  % Other options: Bergen, CambridgeUS, Darmstadt, etc.
\usetheme{metropolis}
\usecolortheme{seagull}  % Subtle colors
\usepackage{helvet}  % Helvetica
\renewcommand{\familydefault}{\sfdefault}
\setbeamertemplate{itemize items}[square]  % Options: circle, ball, square

%% For background color
% \usebackgroundtemplate{
%   \begin{tikzpicture}
%     \path[fill=blue!10] (0,0) rectangle (\paperwidth,\paperheight);
%   \end{tikzpicture}
% }
...
%     \fill[blue!50] (0,0) rectangle (\paperwidth,0.2);
%   \end{tikzpicture}%
% }
...
\newcommand{\green}{\textcolor{nvidiagreen}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\QARMA}{\textcolor{armBlue}{\texttt{QARMA}}\xspace}
\newcommand{\QARMAvi}{\textcolor{armBlue}{\texttt{QARMAv1}}\xspace}
\newcommand{\qarma}[1]{\textcolor{armBlue}{\texttt{QARMA}\textsubscript{#1}}\xspace}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\theinput}[1]{{P_{#1}^{\,i},T_{#1}^{\,i}}}
\newcommand{\theoutput}[1]{{C_{#1}^{\,i},T_{#1}^{\,i}}}
\newcommand{\thepair}{\big((\theinput0),(\theinput1)\big)}
\newcommand{\theinputoutput}[1]{P_{#1}^{\,i},T_{#1}^{\,i},C_{#1}^{\,i}}
\newcommand{\thepairc}{\big((\theinputoutput0),(\theinputoutput1)\big)}

\newcommand{\twoline}[2]{\begin{tabular}{@{}l@{}} #1 \\[1pt] #2  \end{tabular}}
\newcommand{\twoliner}[2]{\begin{tabular}{@{}r@{}} #1 \\[1pt] #2  \end{tabular}}
\newcommand{\threeline}[3]{\begin{tabular}{@{}l@{}} #1 \\[1pt] #2 \\[1pt] #3  \end{tabular}}
\newcommand{\threelinec}[3]{\begin{tabular}{@{}c@{}} #1 \\[1pt] #2 \\[1pt] #3  \end{tabular}}

\def\middleoftworows#1{\multirow[c]{2}{*}[0pt]{#1}}
\newcolumntype{C}[1]{>{\centering\arraybackslash}p{#1}}
\newlength{\tablewidth}
\setlength{\tablewidth}{\dimexpr \textwidth-3\arraycolsep \relax}
...
\definecolor{bluee}{RGB}{0, 0, 255}
\newcommand{\kk}{\textcolor{bluee}{\mathsf{K}}}
\newcommand{\pp}{\textcolor{cyan}{\mathsf{P}}}
\newcommand{\cc}{\textcolor{cyan}{\mathsf{C}}}
